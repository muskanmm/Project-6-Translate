    ...
    var body: some View {
        NavigationStack {
            VStack {
                ...
                NavigationLink(destination: TranslateHistoryView(translateManager: translateManager)) {
            ...
            if let data = data {
                do {
                    ...
                    DispatchQueue.main.async {
                        ...
                        self.translateManager.saveTranslation(translation: translationResponse.responseData.translatedText)
...
//    func saveTranslationToFirebase(translatedText: String) {
//        let translation = Translation(id: UUID().uuidString, translatedText: translatedText)
//        translateManager.saveTranslation(translation: translation)
//        }
}
